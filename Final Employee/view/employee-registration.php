...
?>
    ...
    <section class="catagories">
		<div class="container">
			<h2 class="text-center">Welcome To Employee Portal</h2>
    ...
    <div class="container">
            ...
            <center>
            <form id="form" action="../controller/employeeregisterCheck.php" method="post" enctype="multipart/form-data">
            <table>
            <tr>
                <td>
    ...
    <!--<section class="footer">
        <div class="container text-center">
            <p>All rights reserved. Designed By <a href="#">Niloy</a></p>
        </div>
    </section>-->
